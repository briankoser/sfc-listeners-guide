...
<div class="quote">
  {% timeLink {url:podcast_file_url, t:'3:03'} %}
...
<div class="quote">
  {% timeLink {url:podcast_file_url, t:'4:18'} %}
...
<div class="quote">
  {% timeLink {url:podcast_file_url, t:'8:14'} %}
  <q class="ben">Have you watched {% work "LOST" %}?</q>
  ...
  <q class="ben">That's too intimate for Matt. We can't watch {% work "LOST" %} together until we're married.</q>
  <q data-name="Des">It's on that list.</q>
</div>

<div class="quote">
  {% timeLink {url:podcast_file_url, t:'9:01'} %}
  ...
  <q class="ben">Stop {% work "LOST" %} or stop your marriage?</q>
</div>

<div class="quote">
  {% timeLink {url:podcast_file_url, t:'9:59'} %}
  <q class="matt">Right now, I'm past it. I'm over {% work "LOST" %}. I think everyone knows I'm over {% work "LOST" %}.</q>
...
<div class="quote">
  ...
  <q class="ben">And you will submit to all six seasons of {% work "LOST" %}.</q>
</div>
...
<div class="quote">
  {% timeLink {url:podcast_file_url, t:'31:40'} %}
