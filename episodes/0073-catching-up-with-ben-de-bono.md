...
Matt now rates {% work "The Avengers" %} at 5 stars. Ben rates it 4 stars. 
...
<div class="quote">
  ...
  <q class="ben">Like for example, we took our kids to go see {% work "Brave" %} earlier this week. $26! Just for the tickets! We could have bought the stupid DVD for that much.</q>
  <q class="matt">See man? This is why it's way better to be single and childless!</q>
  <q class="ben">I hear ya.</q>
  <q class="matt">Because I saw {% work "Brave" %} for a mere $5.</q>
</div>
...
<div class="quote">
  ...
  <q class="matt">So Joss Whedon, {% work "Cabin in the Woods" %}, you asked me to see it with you, I said 'yes', and then you saw it with somebody else.</q>
...
<div class="quote">
  ...
  <span class="quote-context is-size-6">The hosts discuss {% work "Prometheus" %}</span>
...
<div class="quote">
  ...
  <q class="ben">This is right up your alley with 'Jesus is a zombie': Jesus is an alien, according to the {% work "Prometheus" %} franchise.</q>
</div>
