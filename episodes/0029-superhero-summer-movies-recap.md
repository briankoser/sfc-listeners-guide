...
<div class="quote">
  <span class="quote-context is-size-6">Matt "predicts" {% workTitle "Arrow" %} and {% workTitle "Flash" %}</span>
...
<div class="quote">
  <span class="quote-context is-size-6">Matt "predicts" {% workTitle "Gotham" %}</span>
...
{% workTitle "The Dark Knight Rises" %} news: Ben had a dream where the first two hours of the movie were Bruce Wayne sitting in the Batcave talking about his emotional issues. 

# Main Topic
Follow up to State of the Superhero episode 

<div class="quote">
  <span class="quote-context is-size-6">On {% workTitle "Thor" %} </span>
...
# Feedback
Matt and Joshua are doing the second SFC Readalong: {% workTitle "A Wizard of Earthsea" %}